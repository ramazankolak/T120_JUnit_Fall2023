...
public class C04_Assertions {
    ...
    public void titleTest(){
        ...
        Assert.assertTrue("Title Amazon icermiyor" ,actualTitle.contains(expectedIcerik));
        System.out.println("Bu mesaj test passed olursa calisir, failed olursa calismaz");
